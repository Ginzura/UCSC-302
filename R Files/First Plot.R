...
#4) Explore the zoom and export tabs on the plot window in the left bottom of the environment

###################################################################
#open an image file, be it pdf, png, jpeg, ps, bmp or a windows meta file
#give an appropriate path
pdf("D:\\MyR\\demo\\myRplot.pdf")
